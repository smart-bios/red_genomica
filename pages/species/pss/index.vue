<template>
    <div class="container mt-3">
        <h2><i>Pseudomonas syringae pv syringae</i></h2>          
        <hr>    
        <b-card no-body>
